      ...
      <div className="wrap prose">
        ...
        <section className="doc" id="privacy" aria-labelledby="privacy-h">
          ...
          <p>
            ...
            Outrush has no backend server of its own, and none of it is uploaded anywhere.
          </p>
          <p>
            The game does make one request of its own. On launch it asks Expo&rsquo;s update
            service whether a newer version of Outrush has been published. That request says
