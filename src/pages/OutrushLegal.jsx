      ...
      <div className="wrap prose">
        ...
        <section className="doc" id="privacy" aria-labelledby="privacy-h">
          ...
          <div className="callout">
            <p>
              <strong>The short version.</strong> Outrush has no account and no server of
          ...
          <p>
            This policy explains how the mobile game <strong>Outrush: Block Escape</strong>{' '}
            (&ldquo;the game&rdquo;, &ldquo;we&rdquo;) handles information. It covers the
            iOS and Android versions of the game and this website.
          </p>
          <p>
          ...
          <p>
            The game keeps a small database on your phone. Nothing in it is transmitted to
            us, because there is nowhere for it to be transmitted to &mdash; the game has
            no backend server and makes no network requests of its own.
          </p>
          <ul>
            <li>Your high scores and past runs</li>
            <li>Stars earned, palettes unlocked and the palette currently equipped</li>
            <li>Daily challenge progress and your day streak</li>
            <li>A display name, only if you choose to type one for a shared score card</li>
            <li>Settings, such as whether sound is muted</li>
          ...
          <p>
            ...
            us, and <strong>deleting the game deletes all of it</strong>. If your device or
            app store is configured to back up app data, that backup is governed by
            Apple&rsquo;s or Google&rsquo;s own policies, not by this one.
          </p>
          ...
          <h3>3. Purchases</h3>
          <p>
            The game offers three optional purchases: Remove Ads, and two packs of stars.
            All of them are processed entirely by <strong>Apple&rsquo;s App Store</strong> or{' '}
            <strong>Google Play</strong>.
          </p>
          <p>
            We never see, receive or store your payment card, billing address or store
            account. What the game receives back from the store is a transaction identifier,
            which it writes to the device&rsquo;s local database for one reason: so that the
            same purchase can never be credited to you twice, and so an interrupted purchase
            can still be delivered when you next open the game.
          </p>
          <p>
            Refunds are handled by the store you bought from, under their policies, not by us.
          </p>
          ...
          <ul>
            ...
            <li>
              No advertising that follows you between the game and other services we run,
          ...
          <h3>6. Children</h3>
          <p>
            Outrush is not directed at children under 13 (or the equivalent minimum age where
          ...
          <h3>7. Your rights</h3>
          <p>
            If you are in the UK, the EEA, or a jurisdiction with comparable law, you have
            rights to access, correct, delete and port your personal data, and to object to
            how it is processed.
          </p>
          <p>
            These are unusually simple to exercise here. We hold no personal data about you on
            any server, so:
          </p>
          <ul>
            <li>
              <strong>To see everything the game holds about you</strong>, open the game
              &mdash; it is all shown there.
            </li>
          ...
          <p>
            ...
            Personalised advertising may count as &ldquo;sharing&rdquo; under California law,
            and you can opt out using the same controls in section 2.
          </p>
          <p>
            You may also complain to your local data protection authority. In the UK that is
            the Information Commissioner&rsquo;s Office.
          </p>

          <h3>8. Data transfers and retention</h3>
          <p>
            We retain no personal data, so there is nothing for us to transfer or to delete on
            a schedule. Data held by our advertising partner may be processed in countries
            outside your own, including the United States, under the safeguards described in
            their own policy.
          </p>
          ...
          <p>
            ...
            this page will change and the updated policy will be published here before the
            change takes effect in a new version of the game.
          </p>
        </section>
        ...
        <section className="doc" id="terms" aria-labelledby="terms-h">
          ...
          <div className="callout">
            <p>
              <strong>The short version.</strong> Play the game, don&rsquo;t try to break it,
              and understand that stars and unlocked palettes live only on your phone &mdash;
              uninstalling loses them. <strong>Remove Ads</strong> is tied to your store account
              and can be restored; stars cannot.
            </p>
          </div>
          ...
          <p>
            ...
            <strong>Outrush: Block Escape</strong> (&ldquo;the game&rdquo;) and this website. By
          ...
          <p>
            ...
            tamper with the game or its stored data to obtain stars, palettes or purchases you have
          ...
          <ul>
            <li>
              ...
              advertising in the game on that store account.
            </li>
            <li>
              <strong>Star packs</strong> &mdash; two consumable packs that add stars to your
              balance.
            </li>
          </ul>
          <p>
            All purchases are made through and charged by <strong>Apple&rsquo;s App Store</strong>{' '}
            or <strong>Google Play</strong>. Prices are shown in your local currency by the store
          ...
          <h3>5. Stars, palettes and other in-game items</h3>
          <p>
            Stars, unlocked palettes, scores and progress are{' '}
          ...
          <ul>
            <li>
              ...
              uninstall the game, reset the device, or lose it, your stars, palettes, scores and
              streak are gone and cannot be recovered by us.
            </li>
            <li>
          ...
          <p>
            We may change the cost of a palette, the rate at which stars are awarded, or the balance
            of the game, as part of normal updates.
          </p>
          ...
          <h3>7. Ownership</h3>
          <p>
            The game, its name, artwork, sounds, level designs, code and this website belong to us or
            our licensors and are protected by copyright and other laws. These terms give you no
            rights in them beyond the licence in section 2.
          </p>
          <p>
        ...
        <section className="doc" id="contact" aria-labelledby="contact-h">
          ...
          <p style={{ marginTop: 26 }}>
            <Link to="/outrush" style={{ fontWeight: 700 }}>&larr; Back to Outrush</Link>
          </p>
        </section>
      </div>
    </GameShell>
