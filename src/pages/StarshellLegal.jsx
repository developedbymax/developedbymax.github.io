...
/* Starshell's own documents, written against what StarshellRN actually does.
   ...
   analytics, and no expo-updates, so not even an update check.

   It is served at /starshell/privacy and at /starshell/terms, with the .html
   spelling of both, because StarshellRN's store copy and release runbook name
   /starshell/privacy.html and /starshell/terms.html. The terms address opens this
   same page at the terms. */
export default function StarshellLegal({ focus }) {
  useMeta(meta[focus === 'terms' ? '/starshell/terms' : '/starshell/privacy']);
  const { hash } = useLocation();

  /* Instant, the way a #terms link lands: the page sets scroll-behavior:
     smooth, and a 4,000px glide on arrival reads as the page misbehaving. */
  useEffect(() => {
    ...
    <GameShell game={game} links={NAV} legal>
      <div className="wrap prose">
        ...
        <p>
          ...
          <strong>Starshell</strong> only &mdash; the other games are separate apps with
          their own policies.
        </p>
        ...
        <section className="doc" id="privacy" aria-labelledby="privacy-h">
          ...
          <p>
            This policy explains how the mobile game <strong>Starshell</strong> (&ldquo;the
          ...
          <p>
            ...
            game opens it asks the store whether that is still true, so a purchase made on
            another device is recognised, and a refunded one is taken back.
          </p>
          <p>Refunds are handled by the store you bought from, under their policies, not by us.</p>

          <h3>4. Crash and error reporting</h3>
          <p>
            <strong>There is none.</strong> Starshell ships no crash-reporting and no analytics
          ...
          <h3>6. Children</h3>
          <p>
            Starshell is not directed at children under 13 (or the equivalent minimum age where
        ...
        <section className="doc" id="terms" aria-labelledby="terms-h">
          ...
          <p>
            ...
            <strong>Starshell</strong> (&ldquo;the game&rdquo;) and this website. By installing or
          ...
          <p>
            ...
            thing it bought is removed from the game.
          </p>
          <p>
        ...
        <section className="doc" id="contact" aria-labelledby="contact-h">
          ...
          <p style={{ marginTop: 26 }}>
            <Link to="/starshell" style={{ fontWeight: 700 }}>&larr; Back to Starshell</Link>
          </p>
        </section>
      </div>
    </GameShell>
